...
class CustomersIT {
    ...
    @Test
    public void shouldNorFindByEmailIfNotCustomerExistsWitchEmail() {
    ...
    @Test
    public void souldReturnIfEmailIsInUse() {
        Customer customer = CustomerTestDataBuilder.brandNewCustomer().build();
        customers.add(customer);
        ...
        Assertions.assertThat(customers.isEmailUnique(new Email("caio@gmail.com"), new CustomerId())).isTrue();
