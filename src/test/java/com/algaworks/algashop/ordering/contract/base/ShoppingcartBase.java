...
import com.algaworks.algashop.ordering.infrastructure.adapters.in.web.shoppingcarts.ShoppingCartController;
...
public class ShoppingcartBase {
    ...
    void setUp() {
        ...
        Mockito.when(managementService.create(Mockito.any(UUID.class)))
